...
abstract class FlutterFlowTheme {
  ...
  late Color roxoclaropreto;
  late Color azulroxo;
  late Color cinzaparanetflix;
  late Color cinzaclaromarron;
  late Color blacktopurple;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color roxoclaropreto = const Color(0xFF9E9FE2);
  late Color azulroxo = const Color(0xFF667EEA);
  late Color cinzaparanetflix = const Color(0xFFC9C9C9);
  late Color cinzaclaromarron = const Color(0xFFD7D7D7);
  late Color blacktopurple = const Color(0xFF000000);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color roxoclaropreto = const Color(0xFF14181B);
  late Color azulroxo = const Color(0xFF9890E3);
  late Color cinzaparanetflix = const Color(0xFF141414);
  late Color cinzaclaromarron = const Color(0xFF1F1E1E);
  late Color blacktopurple = const Color(0xFF9890E3);
