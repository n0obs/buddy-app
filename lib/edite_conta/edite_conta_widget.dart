...
import 'edite_conta_model.dart';
export 'edite_conta_model.dart';

class EditeContaWidget extends StatefulWidget {
  const EditeContaWidget({
    super.key,
    required this.updatesupa,
  });

  final UsersRow? updatesupa;

  @override
  State<EditeContaWidget> createState() => _EditeContaWidgetState();
}

class _EditeContaWidgetState extends State<EditeContaWidget> {
  late EditeContaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditeContaModel());

    _model.telefoneTextController ??= TextEditingController(
        text: valueOrDefault<String>(
      widget.updatesupa?.telefone,
    ...
    _model.enderecofieldTextController ??= TextEditingController(
        text: valueOrDefault<String>(
      widget.updatesupa?.endereco,
      'endereço',
    ));
    _model.enderecofieldFocusNode ??= FocusNode();

    _model.cPFieldTextController ??= TextEditingController(
        text: valueOrDefault<String>(
      widget.updatesupa?.cpf,
      'CPF',
    ));
    _model.cPFieldFocusNode ??= FocusNode();
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText: '123.456.789-08 (exemplo)',
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                          fontFamily:
                                  ...
                                  validator: _model
                                      .cPFieldTextControllerValidator
                                      .asValidator(context),
                                  inputFormatters: [_model.cPFieldMask],
                                ),
                              ),
                            ),
                          ],
                  ...
                  return FFButtonWidget(
                    onPressed: () async {
                      await UsersTable().update(
                        data: {
                          'name': _model.nomefieldTextController.text,
                          'email': _model.emailfieldTextController.text,
                          'city': _model.cidadefieldTextController.text,
                          'endereço': _model.enderecofieldTextController.text,
                          'CPF': _model.cPFieldTextController.text,
